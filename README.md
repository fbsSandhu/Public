...
| :--- | :--- | :--- | :--- |
| **Low-Latency $O(1)$ Limit Order Book** | C++20, Google Benchmark, Google Test | Zero-allocation matching engine on the hot path utilizing intrusive doubly-linked lists and memory pooling. | [`/limit-order-book`](./limit-order-book) |
